...
let secretUsername = ("Admin");
let secretPassword = ("Class");
...
button.addEventListener("click", function() {
    ...
    if (username === secretUsername && password !== secretPassword)
        message.textContent = "Wrong password - be careful, don't mess this up too many times.";
    else if (password === secretPassword && username !== secretUsername)
        message.textContent = "Wrong username - is there a typo?";
    else if (password !== secretPassword && username !== secretUsername)
        message.textContent = "Incorrect username and password. Hmm. Suspicious.";
    ...
    if (username === "" || password === "") {
        message.textContent = "You need to enter SOMETHING.";
    }
